...
namespace Tetris
{
    sealed class PieceGhostSystem : IEcsRunSystem, IEcsInitSystem
    {
        readonly GameContext gameCtx;
        EcsEntity[][] m_Grid => gameCtx.grid;

        EcsFilter<PieceGhostUpdateRequest> m_GhostUpdateRequest;

        EcsFilter<PieceGhostComponent, ComponentList<EcsEntity>, PositionComponent> m_GhostPiece;
        ...
        void CopyState(ref EcsEntity eGhostPiece, in EcsEntity ePiece)
        {
