...
namespace Tetris
{
    ...
    public sealed class BatchRenderer : MonoBehaviour
    {
        ...
        private readonly int m_MainTex_ST = Shader.PropertyToID("_MainTex_ST");
        ...
        {
            if (TransfromMatrixBatches.Count <= 0) return;
            ...
            for (int i = 0; i < TransfromMatrixBatches.Count; i++)
            {
                ...
                if (SpriteOffsetBatches != null && SpriteOffsetBatches.Count > 0)
                {
                    ...
                    m_MPB.SetVectorArray(m_MainTex_ST, offsetBatches);
                }
