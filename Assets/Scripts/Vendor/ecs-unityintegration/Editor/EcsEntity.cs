...
namespace Leopotam.Ecs.UnityIntegration.Editor
{
    ...
    internal sealed class EcsEntityObserverInspector : UnityEditor.Editor
    {
        private const int MaxFieldToStringLength = 128;
        private static object[] _componentsCache = new object[32];
        private EcsEntityObserver _observer;
        ...
        private void DrawTypeField(object instance, FieldInfo field, EcsEntityObserver entity)
        {
