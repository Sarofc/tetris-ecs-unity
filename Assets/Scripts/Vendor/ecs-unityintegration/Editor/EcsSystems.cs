...
namespace Leopotam.Ecs.UnityIntegration.Editor
{
    ...
    internal sealed class EcsSystemsObserverInspector : UnityEditor.Editor
    {
        private EcsSystemsObserver _observer;
        ...
        private void OnInitSystemsGUI(EcsSystems systemsGroup)
        {
        ...
        private void OnRunSystemsGUI(EcsSystems systemsGroup)
        {
        ...
        private void OnDestroySystemsGUI(EcsSystems systemsGroup)
        {
            var systems = systemsGroup.GetAllSystems();
            EditorGUI.indentLevel++;
            for (var i = 0; i < systems.Count; i++)
