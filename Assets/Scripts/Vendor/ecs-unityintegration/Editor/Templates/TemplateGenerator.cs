...
namespace Leopotam.Ecs2.UnityIntegration.Editor.Prototypes
{
    ...
    {
        private const string Title = "LeoECS template generator";
        ...
        private const string ComponentFlagTemplate = "ComponentFlag.cs.txt";
        ...
        private static void CreateComponentFlagTpl()
        {
